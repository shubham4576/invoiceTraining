...
def clone_files(file1_path, file2_path, num_clones):
    ...
    clone_dir = "data/labels/train"
    os.makedirs(clone_dir, exist_ok=True)

    # Create labelme_json_dir of both files
    for i in range(2, num_clones + 2):  # Start naming from invoiceImg_02
        clone_name1 = os.path.join(clone_dir, f"invoiceImg_{i}_1.txt")
        clone_name2 = os.path.join(clone_dir, f"invoiceImg_{i}_2.txt")
...
if __name__ == "__main__":
    file1_path = "yolo_data/invoiceImg_01.txt"  # Replace with actual file path
    file2_path = "yolo_data/invoiceImg_02.txt"  # Replace with actual file path
